<div class="container">
    ...
    <form method="post" action="index.php?action=modifierticket">
        <div class="form-group">
            <input class="form-control" id="titre" value="<?= $billet['titre'] ?>" name="titre" type="text" placeholder="L'objet de la demande" required />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <textarea id="txtCommentaire" rows="7" name="content" class="form-control" placeholder="Veillez mettre en claire le problème ou la question voulue" required><?= $billet['titre'] ?></textarea>
        </div>
